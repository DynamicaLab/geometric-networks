...
fractions = np.linspace(0, 0.99, 36, endpoint=True)[30:]
for rho in tqdm(fractions):
    ...
    np.save('avg_d_per_rho_swaps_part4.npy', average_d_per_rho_swaps)
    np.save('mode_correlations_per_rho_swaps_part4.npy', mode_correlations_per_rho_swaps)
