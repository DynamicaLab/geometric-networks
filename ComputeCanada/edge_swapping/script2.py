...
fractions = np.linspace(0, 0.99, 36, endpoint=True)[15:23]
for rho in tqdm(fractions):
    ...
    for _ in range(N_runs):
        ...
        W_shuffled = double_edge_swap_fraction(W, D, fraction=rho, min_distance=0.1234848484848, max_distance=1.0,
                                               replace=False)
    ...
    np.save('avg_d_per_rho_swaps_part2.npy', average_d_per_rho_swaps)
    np.save('mode_correlations_per_rho_swaps_part2.npy', mode_correlations_per_rho_swaps)
